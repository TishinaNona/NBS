...
namespace Platformer {
    public class PlayerDetector : MonoBehaviour {
        ...
        [SerializeField] float detectionRadius = 7f; // Large circle around enemy
        [SerializeField] float innerDetectionRadius = 4f; // Small circle around enemy
        [SerializeField] float detectionCooldown = 1f; // Time between detections
        [SerializeField] float attackRange = 3f; // Distance from enemy to player to attack
